{#
    Axis 5 — Inventory / stock. On-hand quantity per store × product against all-time
    units sold, with a stock-level band and a "never sold" flag to surface dead stock.
#}
with stocks as (
